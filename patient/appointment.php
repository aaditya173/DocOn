...
<body>
    ...
    //TODO
    $sqlmain = "select appointment.appoid,appointment.appotime,schedule.scheduleid,schedule.title,doctor.docname,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid  where  patient.pid=$userid ";
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div class="h3-search">
                                                                ...
                                                                <div class="h4-search">
                                                                    Scheduled Date: ' . $scheduledate . '<br>Time: <b>@' . $appotime . '</b> (24h)
                                                                </div>
                                                                <br>
